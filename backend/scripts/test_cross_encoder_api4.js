...
async function test() {
  ...
  console.log("Valid default:", res1);
  
  // Actually, pipeline signature doesn't take kwargs for text_classification easily, 
  // maybe we can't specify function_to_apply easily.
  // Wait, let's just use AutoModel and Sigmoid.
}
test();
